...
!ifndef DO_NOT_INSTALL_REQUIREMENTS
  ...
  ${If} $0 == 1
      Messagebox MB_OK "Could not install MPI runtime (version ${MPIRequiredVersion}): MLClusters will not run. Try installing Microsoft MPI directly before installing MLClusters." /SD IDOK
  ${EndIf}
!endif
FunctionEnd
